        ...
        try:
            async with AsyncSessionLocal() as db:
                ...
                if not company:
                    ...
                    send_critical_alert(
                        "FOLLOWUP_COMPANY_NOT_FOUND",
                        "followUp/consumer.py:on_follow_up_message",
                ...
                if errors:
                    ...
                    send_critical_alert(
                        ...
                        "followUp/consumer.py:on_follow_up_message",
                        f"Failed to send follow-up messages: {errors}",
                        contact_id=customer_id,
                        company_id=company_id,
                    )
            ...
            logger.exception(
                "[FollowUp Consumer] Unhandled error: customer=%s, company=%s: %s",
                customer_id,
                company_id,
                e,
            )
            send_critical_alert(
                "FOLLOWUP_UNHANDLED_ERROR",
                "followUp/consumer.py:on_follow_up_message",
                e,
                contact_id=customer_id,
                company_id=company_id,
